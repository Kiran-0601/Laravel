...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card">
                <div class="card-header"><h2 class="text-center">Add Role</h2></div>
                <div class="card-body">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-4">
                                <div class="form-switch" style="padding-bottom: 20px;">
                                    <input class="form-check-input toggle-switch" name="permissions[]" type="checkbox" role="switch" data-id="{{ $permission->id }}" value="{{ $permission->id }}" data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-on="Enabled" data-off="Disabled">
                                    <label>{{ $permission->name }}</label>
                                </div>
                            </div>
                            @endforeach
                        </div>
                        <button type="submit" class="register" style="width: 10%;">Add</button>
                    </form>
                </div>
            </div>
        </div>
