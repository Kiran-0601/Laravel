...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h2 class="text-center">Edit Feedback Type</h2></div>
                <div class="card-body">
                    <form method="POST" action="{{ route('feedback-types.update') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="feedback_type" type="text" class="form-control @error('feedback_type') is-invalid @enderror" value="{{ old('feedback_type', $data->feedback_type) }}" name="feedback_type" autocomplete="feedback_type">
                                @error('feedback_type')
