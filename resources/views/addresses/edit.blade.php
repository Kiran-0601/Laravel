...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><h2 class="text-center">Edit Address</h2></div>
                <div class="card-body">
                    <form method="POST" action="{{ route('address.update') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea id="addline1" class="form-control @error('addline1') is-invalid @enderror" name="addline1" rows="2" autocomplete="addline1">{{ old('addline1', $data->addline1) }}</textarea>
                                @error('addline1')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <textarea id="addline2" class="form-control" name="addline2" rows="2" autocomplete="addline2">{{ old('addline2', $data->addline2) }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="city" class="col-md-3 col-form-label text-md-end">City</label>
                            <div class="col-md-8">
                                <input id="city" type="text" class="form-control @error('city') is-invalid @enderror" value="{{ old('city', $data->city) }}" name="city" autocomplete="city">
                                @error('city')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-8">
                                <input id="pincode" type="text" class="form-control @error('pincode') is-invalid @enderror" value="{{ old('pincode', $data->pincode) }}" name="pincode" autocomplete="pincode">
                                @error('pincode')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
